...
class wbvpageinfo():
    ...
    def praseforwards(self):
        ...
        # print(str(totalpage)+" "+maxid)

        url = 'https://weibo.com/aj/v6/mblog/info/big?ajwvr=6&id=4180780727346027&max_id=4184088305027293&page=1&__rnd=1513048095676'
        try:
...
wbvpage = wbvpageinfo("http://weibo.com/tv/v/FxTtuuP2j")
# wbvpage.prasevideo()
